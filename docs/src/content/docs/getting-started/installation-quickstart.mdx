...
For production, put Kod behind Caddy or nginx to get automatic HTTPS. See the [Configuration guide](/docs/guides/configuration) for details.
:::

## Next Steps

- [Configuration](/docs/guides/configuration) -- Environment variables, CLI flags, and deployment options
- [Workflows](/docs/guides/workflows) -- Automate builds, tests, and deployments
- [Secrets](/docs/guides/secrets) -- Store encrypted secrets for your workflows
